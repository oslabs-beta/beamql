...
const convertTypesforMutationTest = (object) => {
...
const nonjoinTablewithCorrectTypesTest = convertTypesforMutationTest(nonJoinTables);
console.log(nonJoinTables,'after')
// addNullable -> ////////////////////////////////////////////////////////////
const addNullableFieldsTest = (dataWTypes, Nullable) => {
...
// console.log('NONJOINTABLESWITHNULLABLEADDED', addNullableFields(nonjoinTablewithCorrectTypesTest, outputOfIsNullableTest));

const mutatableObject = addNullableFieldsTest(nonjoinTablewithCorrectTypesTest, outputOfIsNullableTest)
// mutation =>  /////////////////////////////////////////////////////////
const mutationTest = (obj) => {
  mutationObj = {};
...
const toReplace = mutationTest(mutatableObject)
console.log('TO REPLACE',toReplace)
// replacer One ///////////////////////////////////////////////////////////
const replacerOneTest = (str) => {
  str =
    "\n" +
    str
      .replace(/:{/g, "(")
...
const finalBaby = replacerOneTest(JSON.stringify(toReplace))
...
const mutationCreator = (obj) => {
  //convert types for mutation
  for (const table in obj) {
    for (const column in obj[table]) {
      switch (obj[table][column]) {
        case "bigint":
          obj[table][column] = "ID";
          break;
        case "integer":
          obj[table][column] = "Int";
          break;
        case "character varying":
          obj[table][column] = "String";
          break;
        case "date":
          obj[table][column] = "ID";
          break;
...
// console.log(mutationCreator(convertTypesforMutation))
// console.log(mutationCreator(terrified))
///////////////////////////////////////
...
const outputOfaddNullableFields35902375690237102375 = {
  planets: {
    _id: "ID!",
    name: "String",
    rotation_period: "Int",
